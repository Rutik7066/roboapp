...
class GreetText extends StatefulWidget {
  final int? trackingIndex;
  const GreetText({this.trackingIndex, super.key});

  @override
  State<GreetText> createState() => _GreetTextState();
}

class _GreetTextState extends State<GreetText> {
