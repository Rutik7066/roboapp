...
class Frame02 extends StatefulWidget {
  final Map<String, dynamic> data;
  const Frame02({super.key, required this.data});
/* {
  ...
  @override
  State<Frame02> createState() => _Frame02State();
}

class _Frame02State extends State<Frame02> {
  @override
        ...
        children: [
          ...
          if (widget.data["show_frame"])
            SizedBox(
              width: width,
              height: width,
              child: Image.asset("assets/frame/frame_d02.png"),
            ),
          // Details
          Align(
