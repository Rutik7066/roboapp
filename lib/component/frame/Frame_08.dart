...
class Frame08 extends StatefulWidget {
  final Map<String, dynamic> data;
  const Frame08({super.key, required this.data});
/* {
  ...
  @override
  State<Frame08> createState() => _Frame08State();
}

class _Frame08State extends State<Frame08> {
  @override
        ...
        children: [
          ...
          if (widget.data["show_frame"])
            SizedBox(
              width: width,
              height: width,
              child: Image.asset("assets/frame/frame_d08.png"),
            ),
