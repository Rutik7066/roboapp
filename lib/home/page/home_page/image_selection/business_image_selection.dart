...
childAspectRatio: 1,
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return FutureBuilder(
                          future: get(Uri.parse(
                              "https://robo.itraindia.org/designnewapi/user/businesslist1?business_category=${cat[index]['id']}&res=1")),
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) {
                                        ...
                                        return ImageSelection(
                                          ...
                                          link:
                                              "https://robo.itraindia.org/designnewapi/user/businesslist?business_category=${e['categoryid']}",
                                          name: e['category'],
                                        );
                                      },
                                    ),
